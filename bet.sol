...
contract BETWHALEBET is Pausable, Ownable, ReentrancyGuard {
    ...
    address public   addressBETWHALE =    0xcEf365B5932558c7E3212053f99634F3D9e078bA;
...
/*
    address public   addressBETWHALE =    0x5947a0EE2c33e24BE35502A671036A7eC2f7f5B7;
...
*/
    ...
    function betting(
        ...
        require(amountTokens <= IERC20(addressBETWHALE).balanceOf(_msgSender()), "No balance to bet");
        ...
        IERC20(addressBETWHALE).transferFrom(msg.sender, address(this), amountTokens);
    ...
    function claimBettingEarning(
        ...
        if (amountTokensOnFirstPoolBet[whatsBet] != 0 && amountTokensOnSecondPoolBet[whatsBet] != 0) {
            ...
            if (whatsMyBetPool == resultFinalBet[whatsBet]) {
                ...
                IERC20(addressBETWHALE).transfer(msg.sender, amountTokens); 
                IERC20(addressBETWHALE).transfer(msg.sender, getEarnOfBetReturn); 
                IERC20(addressBETWHALE).transfer(burnWallet, getAmountFees); 
    ...
    function setAddresses (
        address _addressBETWHALE) 
        external onlyOwner {

        addressBETWHALE = _addressBETWHALE;
    }
    ...
    function setBETWHALEAddressContract (address _addressBETWHALE) external onlyOwner {
        addressBETWHALE = _addressBETWHALE;
    }
